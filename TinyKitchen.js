...
var HEAPF64 = new Float64Array(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1839232;
...
// {{PRE_LIBRARY}}
  ...
  function timerFunc() {
          setInterval(function () {
              num++;
              var fizzBuzz = '';
              if (!(num % 15)) fizzBuzz = 'FizzBuzz';
              else if (!(num % 3)) fizzBuzz = 'Fizz';
              else if (!(num % 5)) fizzBuzz = 'Buzz';
              else if (!fizzBuzz) fizzBuzz = num.toString();
              var len = lengthBytesUTF8(fizzBuzz) + 1;
              var ptr = _malloc(len);
              stringToUTF8(fizzBuzz, ptr, len);
              dynCall_vii(fizzBuzzCallbackPointer, num, ptr);
              _free(ptr);
          }, 1000);
      }function _callbackInit(callbackPtr) {
          fizzBuzzCallbackPointer = callbackPtr;
          timerFunc();
      }
  ...
  var _fetch_work_queue=1314928;function __emscripten_get_fetch_work_queue() {
